...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_coordinates(self):
        """
        Test to ensure that all the coordinates inside the grid are accessed
        """
    ...
    def test_all_grid_neighbours(self):
        """
        ensure all the grid positions have neighbours
        """
        grid = boggle.make_grid(2, 2)
    ...
    def test_coverting_a_path_to_a_word(self):
        """
        ensure path can be converted to words
        """
        grid = boggle.make_grid(2, 2)
    ...
    def test_search_grid_for_words(self):
        """
        Ensure that certain patters can be found in a path
        """
